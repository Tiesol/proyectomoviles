...
import com.ami.FixealoPofabo.databinding.FragmentRegisterBinding

import com.ami.fixealopofabo.viewmodel.RegisterViewModel
...
class RegisterFragment : Fragment() {
    ...
    private fun setupListeners() {
        ...
        binding.btnRegister.setOnClickListener {
            ...
            val email     = binding.txtEmailRegister.editText?.text.toString().trim()
    ...
    private fun observeVM() {
        viewModel.registerResult.observe(viewLifecycleOwner) { result ->
            ...
            result.onSuccess {
                ...
                findNavController().navigate(R.id.action_registerFragment_to_fragment_registered_user)
            }
            result.onFailure {
