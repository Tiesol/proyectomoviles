...
import com.ami.chamba_pofabo.databinding.FragmentLoginBinding
import com.ami.chamba_pofabo.viewmodel.LoginViewModel
    ...
    private fun observeViewModel() {
        viewModel.loginResult.observe(viewLifecycleOwner) { result ->
            result.onSuccess { (token, userId) ->
                ...
                findNavController().navigate(R.id.action_loginFragment_to_myAppointmentsFragment)
            }
